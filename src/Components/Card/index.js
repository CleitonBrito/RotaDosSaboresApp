...
class Card extends Component {
    render(){
        return <div className="card grid grid-cols-[5rem_auto] items-center bg-gradient-to-r to-[#E8E8E8] from-[#F3F4F6] drop-shadow-md shadow-red-600 rounded-2xl w-full min-h-16 sm:min-h-24 my-3">
